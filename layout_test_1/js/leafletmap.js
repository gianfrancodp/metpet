...
//     // Assumendo che 'mappa' sia la tua istanza di L.Map
// mappa.on('popupopen', function(e) {
//     var popup = e.popup;
//     $('#content').html(popup.getContent());
// });
...
// prova recupero dati da file geojson
// fetch('data/CartaGeoTEST.geojson')
...
// //// script file originale
// var map = L.map('map', {
//     zoomControl:true, maxZoom:16, minZoom:1
// })

// var hash = new L.Hash(map);
// map.attributionControl.setPrefix('CCBYSA &middot; Gianfranco Di Pietro &middot; <a href="https://leafletjs.com" title="A JS library for interactive maps">Leaflet</a> &middot;');
